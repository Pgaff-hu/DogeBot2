//-----(PGA~BOT by PGA Bot Inc.)-----\\
//-----(Youtube Channel: PGA FF)-----\\
//-----(Whatsapp number: +918617738028)-----\\
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*PGA BOT*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/G3a3AQndqS5J45eD7zznXF', "groupName": `PGA BOT Inc.`, "footerText": "*PGA BOT*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "PGA BOT"; break;
                case 1: jamss = "PGA BOT"; break;
                case 2: jamss = "PGA BOT"; break;
                case 3: jamss = "PGA BOT"; break;
                case 4: jamss = "PGA BOT"; break;
                case 5: jamss = "PGA BOT"; break;
                case 6: jamss = "PGA BOT"; break;
                case 7: jamss = "PGA BOT"; break;
                case 8: jamss = "PGA BOT"; break;
                case 9: jamss = "PGA BOT"; break;
                case 10: jamss = "PGA BOT"; break;
                case 11: jamss = "PGA BOT"; break;
                case 12: jamss = "PGA BOT"; break;
                case 13: jamss = "PGA BOT"; break;
                case 14: jamss = "PGA BOT"; break;
                case 15: jamss = "PGA BOT"; break;
                case 16: jamss = "PGA BOT"; break;
                case 17: jamss = "PGA BOT"; break;
                case 18: jamss = "PGA BOT"; break;
                case 19: jamss = "PGA BOT"; break;
                case 20: jamss = "PGA BOT"; break;
                case 21: jamss = "PGA BOT"; break;
                case 22: jamss = "PGA BOT"; break;
                case 23: jamss = "PGA BOT"; break;
            }
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*PGA BOT*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `PGA BOT`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/918617738028`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*PGA BOT*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('SCRIPT OF BOT IS PRIVATE')
}
if(isButton == 'ytm'){
reply('https://youtube.com/channel/pgaff')
}
...
stamtus =`❏ 「 \`\`\`MAKER MENU\`\`\` 」
────────────────────
_example: ${prefix}throne PGA FF_
────────────────────
🐶 ${prefix}write 「 text 」
🐶 ${prefix}throne 「 text 」
🐶 ${prefix}logoff 「 text 」
...
──────────────────
*👇SCRIPT GITHUB LINK👇*
SCRIPT OF BOT IS PRIVATE
_BASE : PGA Bot Inc._
_ORI SCRIPT : PGA BOT Version 2_
_OWNER : ${NamaOwner}_
⍟ ────────────────── ⍟`
buttons = [
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `PGA BOT Script`,
          "url": "SCRIPT OF BOT IS PRIVATE"
        },
        "index": 0
      }
    ]
...
const btnbc = {
    ...
    footerText: '*_PGA BOT BROADCAST_*',
    buttons: buttons,
    headerType: 1
}
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`PGA BOT`}, MessageType.location)
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY PGA BOT`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `PGA BOT`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `PGA BOT`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
_Example:_
#ytmp3 https://www.youtube.com/watch?Uiw8s7
